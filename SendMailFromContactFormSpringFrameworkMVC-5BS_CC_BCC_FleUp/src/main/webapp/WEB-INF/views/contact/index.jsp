...
<body>
	...
	<s:form  method="POST" modelAttribute="contact"
		action="${pageContext.request.contextPath }/send"  >
		<h1>Contact Form</h1>
   ...
   <s:input class="form-control" path="CC"/>
  		</div>
  		
  		<div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">BCC:</label>
   <s:input class="form-control" path="BCC"/>
  		</div>
